...
const ReportCard = ({ report, onEdit, onDelete, onDuplicate, onContinueDraft }) => {
    ...
    return (
        <Card hover padding={false} className="overflow-hidden will-change-transform">
            <div className="p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-3">
                            <Link
                                ...
                                className="text-base sm:text-lg font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors line-clamp-2 sm:truncate"
                            >
                                {report.title}
                            </Link>
                        ...
                        {/* Machine Info Grid - Responsive */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3">
                            <p className="flex items-center gap-2">
                                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span className="truncate">{getMachineInfo(report)}</span>
                            </p>
                            ...
                            {report.serial_number && (
                                <p className="flex items-center gap-2">
                                    ...
                                    <span className="truncate">SN: {report.serial_number}</span>
                                </p>
                            )}
                            ...
                            <p className="flex items-center gap-2">
                                ...
                                <span className="truncate">By {report.prepared_by || 'Unknown'}</span>
                            </p>
                            ...
                            <p className="flex items-center gap-2">
                                ...
                                <span className="truncate text-xs">{formatDate(report.created_at)}</span>
                            </p>
                        </div>
                    ...
                    <div className="flex sm:flex-col items-center justify-end gap-1 sm:gap-1 flex-shrink-0">
                        {/* Export Button */}
                        <div className="relative group">
                            <ReportDownload
                                ...
                                buttonVariant="ghost"
                            />
                            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-900 dark:bg-gray-800 text-white text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap z-50">
                                {/* Tooltip arrow */}
                                ...
                                <div className="text-xs text-gray-300 mt-0.5">Download as PDF or DOCX</div>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-900 dark:bg-gray-800 text-white text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap z-50">
                                ...
                                <div className="font-medium">Duplicate Report</div>
                                <div className="text-xs text-gray-300 mt-0.5">Create a copy of this report</div>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-900 dark:bg-gray-800 text-white text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap z-50">
                                ...
                                <div className="font-medium">Edit Report</div>
                                <div className="text-xs text-gray-300 mt-0.5">Modify report details</div>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-900 dark:bg-gray-800 text-white text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap z-50">
                                ...
                                <div className="font-medium text-red-400">Delete Report</div>
                                <div className="text-xs text-gray-300 mt-0.5">Remove report</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {report.is_draft ? (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center w-full sm:w-auto px-4 py-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-medium rounded-lg transition-colors touch-manipulation"
                        >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                            <span className="flex items-center gap-1.5">
                                ...
                                <span className="font-medium">{report.findings?.length || 0}</span> findings
                            </span>
                            <span className="flex items-center gap-1.5">
                                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                </svg>
                                <span className="font-medium">{report.recommendations?.length || 0}</span> recommendations
                            </span>
                        </div>

                        <Link
                            to={`/reports/${report.id}`}
                            className="flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors touch-manipulation"
                        >
